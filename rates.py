...
_ratefile_for_redemption = os.path.abspath(r'data\redemption_rate.dat')
redemption_rate = RateHelper(_ratefile_for_redemption)
...
if __name__ == '__main__':
    ...
    _path_file = os.path.abspath(r'data\redemption_rate.dat')
    # rh = RateHelper(r'G:\Python3\FUND\data\redemption_rate.dat')
    rh = RateHelper(_path_file)
